...
async function seed() {
  ...
  await db.insert(categories).values([
    ...
    // 二级分类
    { id: catPhone, parentId: catDigital, name: '手机', slug: 'phones', iconUrl: 'smartphone', sortOrder: 1 },
    { id: catEarphone, parentId: catDigital, name: '耳机', slug: 'earphones', iconUrl: 'headphones', sortOrder: 2 },
    { id: catSmartWatch, parentId: catDigital, name: '智能手表', slug: 'smart-watches', iconUrl: 'watch', sortOrder: 3 },
    { id: catLaptop, parentId: catComputer, name: '笔记本电脑', slug: 'laptops', iconUrl: 'laptop', sortOrder: 1 },
    { id: catTablet, parentId: catComputer, name: '平板电脑', slug: 'tablets', iconUrl: 'tablet', sortOrder: 2 },
    { id: catKeyboard, parentId: catComputer, name: '键盘鼠标', slug: 'keyboards', iconUrl: 'keyboard', sortOrder: 3 },
    { id: catBigAppliance, parentId: catAppliance, name: '冰箱洗衣机', slug: 'big-appliance', iconUrl: 'refrigerator', sortOrder: 1 },
    { id: catSmallAppliance, parentId: catAppliance, name: '小家电', slug: 'small-appliance', iconUrl: 'fan', sortOrder: 2 },
    { id: catKitchen, parentId: catAppliance, name: '厨房电器', slug: 'kitchen-appliance', iconUrl: 'cooking-pot', sortOrder: 3 },
    { id: catMenswear, parentId: catClothing, name: '男装', slug: 'menswear', iconUrl: 'shirt', sortOrder: 1 },
    { id: catWomenswear, parentId: catClothing, name: '女装', slug: 'womenswear', iconUrl: 'shirt', sortOrder: 2 },
    { id: catShoes, parentId: catClothing, name: '鞋靴', slug: 'shoes', iconUrl: 'footprints', sortOrder: 3 },
    { id: catSnacks, parentId: catFood, name: '零食', slug: 'snacks', iconUrl: 'candy', sortOrder: 1 },
    { id: catDrinks, parentId: catFood, name: '饮料', slug: 'drinks', iconUrl: 'cup-soda', sortOrder: 2 },
    { id: catFresh, parentId: catFood, name: '生鲜', slug: 'fresh', iconUrl: 'salad', sortOrder: 3 },
    { id: catSkincare, parentId: catBeauty, name: '护肤', slug: 'skincare', iconUrl: 'droplets', sortOrder: 1 },
    { id: catMakeup, parentId: catBeauty, name: '彩妆', slug: 'makeup', iconUrl: 'palette', sortOrder: 2 },
    { id: catWashCare, parentId: catBeauty, name: '洗护', slug: 'wash-care', iconUrl: 'bath', sortOrder: 3 },
    { id: catLiterature, parentId: catBooks, name: '文学', slug: 'literature', iconUrl: 'book-open', sortOrder: 1 },
    { id: catEducation, parentId: catBooks, name: '教育', slug: 'education', iconUrl: 'graduation-cap', sortOrder: 2 },
    { id: catComic, parentId: catBooks, name: '漫画', slug: 'comic', iconUrl: 'image', sortOrder: 3 },
    { id: catFitness, parentId: catSports, name: '健身器材', slug: 'fitness', iconUrl: 'dumbbell', sortOrder: 1 },
    { id: catOutdoor, parentId: catSports, name: '户外装备', slug: 'outdoor', iconUrl: 'tent', sortOrder: 2 },
    { id: catSportswear, parentId: catSports, name: '运动服饰', slug: 'sportswear', iconUrl: 'shirt', sortOrder: 3 },
    { id: catFurniture, parentId: catHome, name: '家具', slug: 'furniture', iconUrl: 'sofa', sortOrder: 1 },
    { id: catBedding, parentId: catHome, name: '床上用品', slug: 'bedding', iconUrl: 'bed', sortOrder: 2 },
    { id: catStorage, parentId: catHome, name: '收纳', slug: 'storage', iconUrl: 'archive', sortOrder: 3 },
    { id: catMilkPowder, parentId: catBaby, name: '奶粉', slug: 'milk-powder', iconUrl: 'milk', sortOrder: 1 },
    { id: catDiaper, parentId: catBaby, name: '纸尿裤', slug: 'diapers', iconUrl: 'baby', sortOrder: 2 },
    { id: catToys, parentId: catBaby, name: '玩具', slug: 'toys', iconUrl: 'blocks', sortOrder: 3 },
  ]);
